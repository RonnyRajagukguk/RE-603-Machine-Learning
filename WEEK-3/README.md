...
EDA digunakan untuk memahami karakteristik dataset, mengidentifikasi pola distribusi data, mendeteksi outlier, menangani missing value, serta melakukan encoding pada variabel kategorikal.
